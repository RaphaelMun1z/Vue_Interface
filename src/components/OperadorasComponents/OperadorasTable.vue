<template>
    <section id="page-section">
        <section class="main-container">
            <div class="main-container-sides left-side">
                <aside>
                    <div class="logo-container">
                        <svg fill="#FFF" preserveAspectRatio="xMidYMid meet" data-bbox="0 0.02 1242.09 287.41" viewBox="0 0.02 1242.09 287.41" xmlns="http://www.w3.org/2000/svg" data-type="shape" role="presentation" aria-hidden="true" aria-label="">
                            <g>
